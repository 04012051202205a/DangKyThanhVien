<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangKyThanhVien.aspx.cs" Inherits="lap3.DangKyThanhVien" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .bg-info h3 text-center text-primary{
            height: 100px;
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellpadding="5" cellspacing="0" class="auto-style1">
            <tr>
                <td class="bg-info h3 text-center text-primary" colspan="5">Hồ sơ đăng ký</td>
            </tr>
            <tr>
              <td class="text-center" colspan="2" style="color: purple; background-color: red;">Thông tin đăng nhập</td>
<td class="text-center" style="color: purple; background-color: firebrick;">Hồ sơ khách hàng</td>
            ...
            <tr>
                ...
                <td style="vertical-align:top" rowspan="12">
                    ...
                    <br />
                    <asp:ValidationSummary ID="vsLoi" runat="server" ForeColor="#FF3300" Height="280px"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="text-center" colspan="2" style="color: purple; background-color: orangered;">Thông tin cá nhân</td>
            </tr>
            <tr>
